...
setwd("C:/Users/Christine/Desktop/python/dm/data_analysis/data/")
library(tidyverse)
library(dplyr)
library(lme4)
library(readr)
...
dat = read.csv("C:/Users/Christine/Desktop/python/dm/data_analysis/data/output_data/full_data_dm_3_12.csv")
...
choice = choice %>% filter(rt != "null") %>% 
  ...
  mutate(bin.mem=ntile(choice$delta.mem, 5)) %>% 
  mutate(bin.rt=ntile(choice$rt, 5)) %>% 
